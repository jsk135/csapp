...
int allOddBits(int x) {
  ...
  // int C = (x>>16)&170;
  // int D = (x>>24)&170;
  return !(((~x)|~(x>>8)|~(x>>16)|~(x>>24))&170);
  // return !(((~x)&170)|((~(x>>8))&170)|((~(x>>16))&170)|((~(x>>24))&170));
  // return (!~(A^~170))&(!~(B^~170))&(!~(C^~170))&(!~(D^~170));
  // return !(~(A | B | C | D));
}
/* 
 * negate - return -x 
...
int isAsciiDigit(int x) {
  ...
  // int B = x&15;//x的0~3位
  // !A^~48 B&8
  return (!(x&~255))&(!~((x&240)^~48)) & ((!(x&8)) | (!(x&6)));
  // return (!(x&~255))&(!~((x&240)^~48)) & ((!((x&15)&8)) | (!((x&15)&6)));
  // return !(((x&~255))|(~((x&240)^~48)) | ((((x&15)&8)) | (((x&15)&6))));
  // return !(C&(~(A^~48)) & ((B&8) | (B&6)));
}
/* 
